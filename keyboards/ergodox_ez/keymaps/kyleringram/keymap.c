...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(KC_EQUAL,KC_1,KC_2,KC_3,KC_4,KC_5,KC_SLASH,KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,KC_LPRN,KC_CAPSLOCK,KC_A,LSFT_T(KC_S),LCTL_T(KC_D),LALT_T(KC_F),KC_G,KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_LBRACKET,KC_LALT,TG(1),TG(2),TG(3),TG(4),LCA_T(KC_KP_PLUS),KC_DELETE,KC_DQUO,KC_BSPACE,LT(4,KC_ESCAPE),LGUI_T(KC_QUOTE),MT(MOD_HYPR, KC_BSLASH),KC_6,KC_7,KC_8,KC_9,KC_0,KC_BSPACE,KC_RPRN,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_TILD,KC_H,RSFT_T(KC_J),RCTL_T(KC_K),RALT_T(KC_L),LT(2,KC_SCOLON),KC_MINUS,KC_RBRACKET,KC_N,KC_M,KC_UP,KC_COMMA,KC_DOT,KC_RSHIFT,KC_LEFT,KC_DOWN,KC_RIGHT,KC_SLASH,KC_RALT,KC_HOME,KC_DLR,KC_END,RGUI_T(KC_KP_ASTERISK),LT(2,KC_ENTER),LT(3,KC_SPACE)),

  [1] = LAYOUT_ergodox(KC_EQUAL,KC_1,KC_2,KC_3,KC_4,KC_5,KC_SLASH,KC_TAB,KC_Q,KC_W,KC_F,KC_P,KC_G,KC_LPRN,KC_CAPSLOCK,KC_A,KC_R,KC_S,KC_T,KC_D,KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_LBRACKET,KC_LALT,KC_TRANSPARENT,TG(2),TG(3),TG(4),LCA_T(KC_KP_PLUS),KC_DELETE,KC_DQUO,KC_BSPACE,LT(4,KC_ESCAPE),LGUI_T(KC_QUOTE),KC_BSLASH,KC_6,KC_7,KC_8,KC_9,KC_0,KC_BSPACE,KC_RPRN,KC_J,KC_L,KC_U,KC_Y,KC_SCOLON,KC_TILD,KC_H,KC_N,KC_E,KC_I,KC_O,KC_MINUS,KC_RBRACKET,KC_K,KC_M,KC_UP,KC_COMMA,KC_DOT,KC_RSHIFT,KC_LEFT,KC_DOWN,KC_RIGHT,KC_RALT,KC_RALT,KC_HOME,RCTL_T(KC_SCOLON),KC_END,RGUI_T(KC_KP_ASTERISK),LT(2,KC_ENTER),LT(3,KC_SPACE)),
